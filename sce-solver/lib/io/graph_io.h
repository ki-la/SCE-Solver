...
public:
    ...
    readTemporalGraph(std::string file) {
        ...
        return std::make_pair(numVtxs, edges);
    }

    template <class Graph = graph_access>
    static std::shared_ptr<Graph> createGraphFromEdgeList(int64_t* starts, int64_t* ends, int64_t* weights, uint32_t n, uint32_t m) {
